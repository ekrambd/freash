                ...
                <div class="col-md-8 ">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/insert-salary') }}" method="post" enctype="multipart/form-data">
                            	@csrf
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputPassword20"> Pay Salary</label>
                                    <input type="text" class="form-control" name="paid_amount" value="{{$employees->salary}}" required>
                                </div>
