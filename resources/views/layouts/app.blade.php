                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{URL::to('/all-paid_salary')}}">All Paid Salary</a></li>     
                                </ul>
                            </li>
                             <li class="has_sub">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{URL::to('/today-sales')}}">Today's Report</a></li>
                                    <li><a href="{{URL::to('/monthly-sale')}}">Monthly Report</a></li> 
                                    <li><a href="{{URL::to('/yearly-sales')}}">Yearly Report</a></li>    
                                </ul>
                            </li>
                            <li class="has_sub">
