...
ROute::get('/salary-pay/{id}', 'SalaryController@SalaryPay');
...
//Sales Report
Route::get('/today-sales', 'SalesController@index');
Route::get('delete-order-status/{id}', 'SalesController@DeleteOrder');
Route::get('/yearly-sales', 'SalesController@YearlySale');
Route::get('/monthly-sale', 'SalesController@MonthlySale');
